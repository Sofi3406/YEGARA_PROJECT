    ...
    <div className="space-y-6">
      <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 px-6 py-8 text-white shadow-xl md:px-8">
        ...
        <div className="relative flex flex-col gap-6 md:flex-row md:items-end md:justify-between">
          <div className="max-w-2xl">
            <p className="inline-flex items-center rounded-full border border-cyan-300/30 bg-cyan-400/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.22em] text-cyan-200">
              Resident feed
            </p>
            <h1 className="mt-4 text-3xl font-semibold tracking-tight md:text-5xl">Announcements</h1>
            <p className="mt-3 max-w-xl text-sm leading-6 text-slate-300 md:text-base">
              Stay in the loop with community notices, service updates, and important information shared for residents.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3 md:min-w-[280px] md:grid-cols-1">
            ...
            <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 backdrop-blur-sm">
              ...
              <p className="mt-1 text-sm font-medium text-cyan-200">Resident dashboard</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {announcements.length === 0 ? (
        <div className="rounded-2xl border border-dashed border-slate-300 bg-white p-8 text-center text-slate-600 shadow-sm">
          ...
          <p className="mt-2 text-sm text-slate-500">New community announcements will appear here as soon as administrators publish them.</p>
        </div>
      ) : (
          ...
          {announcements.map((item, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="absolute right-0 top-0 h-32 w-32 -translate-y-1/2 translate-x-1/2 rounded-full bg-cyan-100/50 blur-3xl transition-opacity group-hover:opacity-80" />
                ...
                <div className="p-5 md:p-6">
                  <div className="flex flex-wrap items-start justify-between gap-3">
                    <div className="flex items-start gap-4 min-w-0">
                      ...
                      <div className="min-w-0">
                        <p className="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Announcement {index + 1}</p>
                  ...
                  <div className="mt-5 flex flex-wrap items-center justify-between gap-3 border-t border-slate-100 pt-4">
                    ...
                    <Link to="/resident/dashboard" className="text-sm font-medium text-primary-600 transition-colors hover:text-primary-700">
                      Back to dashboard
                    </Link>
                  </div>
                </div>
