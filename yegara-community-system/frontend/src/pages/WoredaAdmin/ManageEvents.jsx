  ...
  return (
    <PortalPage>
      <PortalHero
        ...
        title="Manage events"
        description="Create, update, and publish community events. Click an event to view registrations."
      />

      <PortalFormPanel title={editing ? 'Edit event' : 'Create new event'} onSubmit={handleSubmit}>
